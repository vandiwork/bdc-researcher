...
def write_overlap(pairs_data: dict) -> int:
    ...
    html = (
        ...
        '<a href="screener.html">Ranking</a>'
...
def write_screener(all_data: dict, pairs_data: dict, md_data: list) -> int:
    ...
    html = (
        '<!DOCTYPE html><html lang="en"><head>\n'
        '<meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1">\n'
        '<title>BDC Ranking &mdash; BDC Researcher</title>\n'
        '<link rel="stylesheet" href="assets.css">\n'
        '<style>\n'
        ...
        '<a href="markdelta.html">Mark Delta</a><a href="screener.html" class="active">Ranking</a>'
        '<a href="comps.html">Comps</a><a href="news.html">News</a>'
        '<a href="status.html">Status</a>\n'
        '<div class="spacer"></div></nav>\n'
        '<div class="page"><h1>BDC Ranking</h1>\n'
